...
{
    public partial class aeroPrilet : MetroFramework.Forms.MetroForm
    {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                query1.CommandText = "INSERT INTO АэропортПрибытия(Название,СтранаПрибытия,ГородПрибытия,ЧасовойПояс,Адрес) VALUES(@Name,@Сountry,@City,@TimeZone,@Address)";
